...
export default class ApiService {
    ...
    // static BASE_URL = "http://localhost:8086/api";
     ...
     static BASE_URL = "https://pharma2.shop/api";
...
// Formula Endpoints
static async saveFormula(data) {
    const response = await axios.post(`${this.BASE_URL}/formulas/save-formula`, data, {
        headers: this.getHeader()
    });
    return response.data;
}
...
static async getAllFormulas() {
    const response = await axios.get(`${this.BASE_URL}/formulas/getall`, {
        headers: this.getHeader()
    });
    return response.data;
}
...
static async updateFormula(id, data) {
    const response = await axios.put(`${this.BASE_URL}/formulas/update/${id}`, data, {
        headers: this.getHeader()
    });
    return response.data;
}
...
static async deleteFormula(id) {
    const response = await axios.delete(`${this.BASE_URL}/formulas/delete-formula/${id}`, {
        headers: this.getHeader()
    });
    return response.data;
}
